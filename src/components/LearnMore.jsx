...
const LearnMore = ({ item, onClose }) => {
  ...
  return (
    <>
      ...
      <div className="p-6 h-screen md:h-auto bg-white rounded-lg shadow-lg z-50 overflow-y-auto custom-scrollbar w-full md:mx-[10%] lg:w-[1000px] absolute top-0 bottom-0 lg:mt-10 lg:mb-10">
        {/* GRIDED CONTAINER */}
